  ...
  return (
    <ErrorBoundary>
      <div className="relative min-h-screen bg-[#070b10] text-slate-100 font-sans selection:bg-amber-500/30">
        {/* ========================================================================= */}
        {/* 1. CLEAN FULLSCREEN ALPINE NATURE BACKDROP (Zero 2D Building in Image)     */}
        {/* ========================================================================= */}
        <div className="fixed inset-0 w-full h-full pointer-events-none z-0 overflow-hidden select-none">
          ...
          />
          {/* Soft twilight gradient overlays on the left for text contrast */}
          <div className="absolute inset-0 bg-gradient-to-t from-[#070b10] via-slate-950/25 to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#070b10]/85 via-slate-950/40 to-transparent w-full sm:w-1/2 lg:w-2/5" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_45%,rgba(7,11,16,0.5)_100%)]" />
        </div>
